...
FILE *open_ffmpeg(const char *output, const char *codec, const char *res, const char *dst_res, const char *fps, const char *crf, const char *rate_control, const char *bitrate_kbps);
